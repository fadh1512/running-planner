  ...
  return (
    <div className="space-y-4 sm:space-y-6 page-enter">
      ...
      <div className="flex gap-1 bg-gray-100 p-1 rounded-xl w-fit">
        <button onClick={() => setActiveTab('running')} className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all ${activeTab === 'running' ? 'bg-white shadow-sm text-emerald-700' : 'text-gray-500 hover:text-gray-700'}`}>
          🏃 Running
        </button>
